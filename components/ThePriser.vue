<template>
  ...
  <div class="flex gap-8 p-8 mb-7">
    ...
    <div class="flex-1 border-neon-neongreen p-8 flex flex-col">
      ...
      <div class="flex-grow">
        <p class="text-white text-center text-xl mb-4">60 DKK</p>
    ...
    <div class="flex-1 border-neon-neonpink p-8 flex flex-col">
      ...
      <div class="flex-grow">
        <p class="text-white text-center text-xl mb-4">100 DKK</p>
    ...
    <div class="flex-1 border-neon-neonorange p-8 flex flex-col">
      ...
      <div class="flex-grow">
        <p class="text-white text-center text-xl mb-4">130 DKK</p>
    ...
    <div class="flex-1 border-neon-neonblue p-8 flex flex-col">
      ...
      <div class="flex-grow">
        <p class="text-white text-center text-xl mb-4">160 DKK</p>
