...
<div class="flex-1 p-6 border-neon-neonred">
  <h2 class="text-white text-2xl font-bold mb-8">Kontakt os</h2>
  <div class="mb-8 flex items-center text-white">
    <img src="/icons/lokation.svg" alt="Adresse ikon" class="w-6 h-6 mr-4" />
    <span class="text-white">Mønstervej 60 6854 Henne</span>
  </div>
  <div class="mb-8 flex items-center text-white">
  ...
  <div class="flex items-center text-white">
    ...
    <!-- Maps -->
<div class="flex-1 border-neon-neonred md:p-6 flex items-center justify-center mt-6 md:mt-0 box-border">     
     <iframe
